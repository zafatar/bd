  ...
  <div class="row m-0">
    <div class="col-lg-8 p-0 text-left">
      <span class="list-group-item list-group-item-action">
        <a title="Image Processing for Remote Sensing" href="https://www.rsim.tu-berlin.de/menue/teaching/" target="_blank">Image Processing for Remote Sensing</a>, TU Berlin, Faculty of Electrical Engineering and Computer Science, Summer Term 2019.
      </span>
      <span class="list-group-item list-group-item-action">
        <a title="Machine Learning for Remote Sensing Data Analysis" href="https://www.rsim.tu-berlin.de/menue/teaching/" target="_blank">Machine Learning for Remote Sensing Data Analysis</a>, TU Berlin, Faculty of Electrical Engineering and Computer Science, Winter Term  2018.
      </span>
      <span class="list-group-item list-group-item-action">
